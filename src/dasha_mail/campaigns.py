...
class Campaigns(BaseEntity):
    ...
    def create(self, list_id: int=None, **params):
            ...
            return self.api_client.send_request('campaigns.create', params)   # Возвращается ID созданной рассылки
    ...
    def delete(self, campaign_id: int=None):
            return self.api_client.send_request('campaigns.delete',{'campaign_id':campaign_id})
    ...
    def get_attachments(self, campaign_id: int=None):
            return self.api_client.send_request('campaigns.get_attachments',{'campaign_id':campaign_id})
        
    def delete_attachments(self, campaign_id: int=None, id: int=None):
            params = {'campaign_id' : campaign_id, 'id' : id}
            return self.api_client.send_request('campaigns.delete_attachment', params)
    ...
    def get_saved_templates(self, **params):
            return self.api_client.send_request('campaigns.get_saved_templates', params)
    ...
    def delete_template(self, id: int=None):
            return self.api_client.send_request('campaigns.delete_template', {'id':id})

    def force_auto(self, campaign_id:int=None, member_id:int=None, **params): 
    ...
    def multi_create(self, json: dict=None):
            return self.api_client.send_request('campaigns.multi_create',{'json':json})
        
    def multi_get(self, campaign_id):
            return self.api_client.send_request('campaigns.multi_get', {'campaign_id':campaign_id})
        
    def multi_update(self, campaign_id: int=None, json: dict=None):
            return self.api_client.send_request('campaign.multi_update', {'campaign_id':campaign_id, 'json':json})
    ...
    def pause(self, campaign_id):
            return self.api_client.send_request('campaigns.pause', {'campaign_id':campaign_id})
        
    def restart_paused(self, campaign_id):
            return self.api_client.send_request('campaigns.restart_paused', {'campaign_id':campaign_id})
